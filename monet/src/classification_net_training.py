...
batchsize = 32
T = np.arange(15,25,0.1) # this provides another layer of stochasticity to make the network more robust
steps = 30
...
callbacks = [
         ReduceLROnPlateau(monitor='val_loss',
                           ...
                           verbose=1,
                           min_lr=1e-9),
         ModelCheckpoint(filepath=f'../../models/{steps}_class_model.h5',
                         monitor='val_acc',
